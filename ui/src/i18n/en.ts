const en: Record<string, string> = {
  ...
  tab_new: 'New Tab', tab_no_connections: 'No SSH connections', tab_close: 'Close tab', tab_close_confirm: 'Close this tab and its terminal session?', workspace_close: 'Close workspace', workspace_close_confirm: 'Close this workspace and all terminal sessions in it?', workspace_close_last: 'Keep at least one workspace open.', broadcast_off: 'Broadcast', broadcast_pane: 'This Pane', broadcast_all: 'All Tabs',
