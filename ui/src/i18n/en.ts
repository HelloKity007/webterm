const en: Record<string, string> = {
  ...
  file_remote_files: 'Remote files', file_open_files: 'Open files', file_unsaved: 'Unsaved changes', file_close_unsaved: 'Discard unsaved changes and close this file?', file_split_editor: 'Split editor', file_close_split: 'Close split editor', file_editor_empty_title: 'Open a remote file to edit', file_editor_empty_hint: 'Choose a file from the explorer. Open files stay here as tabs.',
